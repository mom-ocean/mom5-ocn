...
var NEWS_ITEMS = [{"title": "MOM 5.1.0 Released",
                   ...
                   "date": "March 25, 2014",
                   "block": "<p>MOM developers are pleased to announce the release of MOM 5.1.0. This version is very close to MOM 5.0.2, but with infrastructure updates to support more platforms; new and improved diagnostic capabilities; many bug fixes as reported through the MOM community; and a new ecosystem model known as COBALT. As a general rule for updating code, please test the new code by comparing to your earlier results.</p><p>Happy modeling, Stephen Griffies for the MOM development team.</p>", 
